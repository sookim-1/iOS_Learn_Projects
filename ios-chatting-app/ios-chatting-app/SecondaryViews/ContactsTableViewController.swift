...
class ContactsTableViewController: UITableViewController, UISearchResultsUpdating, UserTableViewCellDelegate {
    ...
    var users: [FUser] = []
    var matchedUsers: [FUser] = [] // 연락처와 일치하는 유저
    var filteredMatchedUsers: [FUser] = [] // 검색 기능
    var allUsersGrouped = NSDictionary() as! [String : [FUser]]
    var sectionTitleList: [String] = [] // 검색 이니셜
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if !isGroup {
            ...
            if !checkBlockedStatus(withUser: userToChat) {
                ...
                ProgressHUD.showError("치단된 사용자입니다")
            }
    ...
    @objc func inviteButtonPressed() {
        ...
        let text = "ios-chatting-app에 초대합니다! \(kAPPURL)"
        ...
        activityViewController.setValue("ios-chatting-app을 시작하세요", forKey: "subject")
